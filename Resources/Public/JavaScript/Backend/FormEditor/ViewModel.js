	...
	return (function ($, Helper) {
		...
		function _subscribeEvents() {
			...
			getPublisherSubscriber().subscribe('view/inspector/editor/insert/perform', function (topic, args) {
				if (args[0]['templateName'] === 'Inspector-HubspotPropertySelectEditor') {
					renderHubspotPropertySelectEditor(
						args[0],
						args[1],
						args[2],
						args[3]
		 ...
		 * @throws 1475421052
		 */
		function renderHubspotPropertySelectEditor(editorConfiguration, editorHtml, collectionElementIdentifier, collectionName) {
