...
return [
    ...
    'types' => [
        '0' => [
            'showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, name, hubspot_cta_code,
            --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:access, hidden;;1, starttime, endtime'
        ],
    ],
    'columns' => [
        'sys_language_uid' => [
