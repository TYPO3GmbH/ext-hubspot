...
/**
 * Event called before a frontend user is compared with a hubspot contact and updated.
 *
 * @see ContactSynchronizationService::compareAndUpdateFrontendUserAndHubspotContact()
 */
class BeforeUpdatingFrontendUserAndHubspotContactEvent extends AbstractContactSynchronizationEvent
{
